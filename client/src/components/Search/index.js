        ...
        <div className="about-Container">
          ...
          <div className="howContainer">
            <div className="container1">
              ...
              <div className="text2">
                Pick your muscle to learn exercises for{" "}
              </div>
            </div>
            ...
            <div className="container1">
              ...
              <div className="text2">
                Chose your favorite excercises from the search
              </div>
            </div>
            <div className="arrow">➪</div>
            <div className="container1">
        ...
        <div className="bmiExample">
          ...
          <div className="bmiTextBox">
            <div className="bmiText">
              ...
              <p className="bmiTextP">
                A person's body mass index (BMI) is an estimate of their body
                fat based on their height and weight.
              </p>
              <p className="bmiTextP">
                {" "}
                Doctors use BMI to assess an adult's health status and potential
                health risks. People with higher BMIs are more likely to develop
